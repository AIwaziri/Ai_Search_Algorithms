...
class DFS:
    ...
    def __init__(self, maze, initial, target):
        self.maze = maze
        self.initial = initial
        self.target = target

        path = self.dfs(self.maze, self.initial, self.target)
        if path:
        ...
        self.dfs(self.maze, self.initial, self.target)

    def dfs(self, maze, initial, target):
        stack = [initial]
